  ...
  methods: {
    addEvent: function addEvent() {
      ...
      Teacher.createEvent(this.event).then(function (res) {
        ...
        _this.$store.state.Event.spinner = false;
        _this.$store.state.Event.response = true;
        _this.$store.state.Event.responseColor = "green";
        _this.$store.state.Event.responseText = "Nova anketa je bila dodana!";
        _this.$store.state.Event.responseIcon = 'mdi-check';
      })["catch"](function (err) {
        _this.$store.state.Event.spinner = false;
        _this.$store.state.Event.response = true;
        _this.$store.state.Event.responseColor = "red";
        _this.$store.state.Event.responseText = "Napaka pri dodajanju nove ankete!";
        _this.$store.state.Event.responseIcon = 'mdi-emoticon-sad-outline';
      });
    }
  },
  computed: {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Components_Response__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../Components/Response */ "./resources/js/App/Components/Response.vue");
/* harmony import */ var _addNewEvent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addNewEvent */ "./resources/js/App/Pages/Teacher/Groups/addNewEvent.vue");
/* harmony import */ var _newVoteEvent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./newVoteEvent */ "./resources/js/App/Pages/Teacher/Groups/newVoteEvent.vue");
/* harmony import */ var _Services_Api_Factory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../Services/Api/Factory */ "./resources/js/Services/Api/Factory.js");
...
var Teacher = _Services_Api_Factory__WEBPACK_IMPORTED_MODULE_3__["Factory"].get('Teacher');
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    addNewEvent: _addNewEvent__WEBPACK_IMPORTED_MODULE_1__["default"],
    newVoteEvent: _newVoteEvent__WEBPACK_IMPORTED_MODULE_2__["default"],
    Response: _Components_Response__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  name: "group",
  data: function data() {
    return {
  ...
  methods: {
    ...
    createPoll: function createPoll() {
      ...
      Teacher.createPoll(this.poll).then(function (res) {
        _this.$store.state.Event.spinner = false; // Response

        _this.$store.state.Event.response = true;
        _this.$store.state.Event.responseColor = "green";
        _this.$store.state.Event.responseText = "Nova dogodek je bil dodan!";
        _this.$store.state.Event.responseIcon = 'mdi-check';
        ...
        _this.$store.state.Event.spinner = false;
        _this.$store.state.Event.responseColor = "red";
        _this.$store.state.Event.responseText = "Napaka pri dodajanju novega dogodka!";
        _this.$store.state.Event.responseIcon = 'mdi-emoticon-sad-outline';
      });
    }
  }
    ...
    [
      ...
      _c("response", {
        attrs: {
          icon: "mdi-check",
          color: "green",
          text: "Dogodek je bil uspešno dodan"
        }
      })
    ],
    1
